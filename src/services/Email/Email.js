...
var Email = /** @class */ (function () {
     ...
     */
    Email.prototype.createTransporter = function () {
     ...
     * @param {string} text
     */
    Email.prototype.send = function (subject, html, text) {
        if (text === void 0) { text = ''; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createTransporter().sendMail({
